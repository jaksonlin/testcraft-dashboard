...
public class PersistenceReadFacade {
    ...
    public PersistenceReadFacade() {
        ...
        this.testArtifactQueryService = new TestArtifactQueryService(new JdbcTestClassAdapter(),
                new JdbcTestMethodAdapter());
    ...
    public Optional<RepositoryRecord> getRepositoryById(Long id) {
        return repositoryQueryService.getById(id);
    }

    public List<RepositoryRecord> listRepositoriesByTeam(Long teamId) {
        return repositoryQueryService.listByTeamId(teamId);
    }

    public List<RepositoryRecord> listAllRepositories() {
        return repositoryQueryService.listAll();
    }

    // Teams
    public List<Team> listTeams() {
        return teamQueryService.listAll();
    }

    // Scan sessions
    public List<ScanSession> recentScanSessions(int limit) {
        return scanSessionQueryService.recent(limit);
    }

    public Optional<ScanSession> getLatestCompletedScanSession() {
    ...
    public List<TestClass> listClassesByRepositoryIdAndScanSessionId(Long repositoryId, Long scanSessionId) {
        return testArtifactQueryService.listClassesByRepositoryIdAndScanSessionId(repositoryId, scanSessionId);
    }

    public Optional<TestClass> listClassByRepositoryIdAndScanSessionIdAndFilePath(Long repositoryId, Long scanSessionId,
            String filePath) {
        return testArtifactQueryService.listClassByRepositoryIdAndScanSessionIdAndFilePath(repositoryId, scanSessionId,
                filePath);
    }

    public long countClassesByScanSessionId(Long scanSessionId) {
        return testArtifactQueryService.countClassesByScanSessionId(scanSessionId);
    }

    public Optional<TestClass> getTestClassById(Long classId) {
        return testArtifactQueryService.getTestClassById(classId);
    }

    public List<TestMethod> listMethodsByTestClassId(Long testClassId) {
        return testArtifactQueryService.listMethodsByTestClassId(testClassId);
    }

    public List<TestMethod> listMethodsByScanSessionId(Long scanSessionId) {
        return testArtifactQueryService.listMethodsByScanSessionId(scanSessionId);
    }

    public List<TestMethod> listAnnotatedMethodsByRepositoryIdAndScanSessionId(Long repositoryId, Long scanSessionId) {
        return testArtifactQueryService.listAnnotatedMethodsByRepositoryIdAndScanSessionId(repositoryId, scanSessionId);
    }

    public Optional<TestMethod> getTestMethodById(Long methodId) {
        return testArtifactQueryService.getTestMethodById(methodId);
    }
    ...
    public List<TestMethodDetailRecord> listTestMethodDetailsByScanSessionId(Long scanSessionId, Integer limit) {
        return testArtifactQueryService.listTestMethodDetailsByScanSessionId(scanSessionId, limit);
    }

    public long countTestMethodDetailsByScanSessionId(Long scanSessionId) {
        return testArtifactQueryService.countTestMethodDetailsByScanSessionId(scanSessionId);
    }
    ...
    public List<TestMethodDetailRecord> listTestMethodDetailsWithFilters(
            java.util.Map<Long, Long> latestSessions, String teamName, String repositoryName,
            String packageName, String className, Boolean annotated, String searchTerm, String codePattern,
            Integer offset, Integer limit) {
        return testArtifactQueryService.listTestMethodDetailsWithFilters(
    ...
    public long countTestMethodDetailsByTeamIdAndScanSessionId(Long teamId, Long scanSessionId) {
        return testArtifactQueryService.countTestMethodDetailsByTeamIdAndScanSessionId(teamId, scanSessionId);
    }
    ...
    public List<TestMethodDetailRecord> listTestMethodDetailsByRepositoryIdAndScanSessionId(Long repositoryId,
        ...
        return testArtifactQueryService.listTestMethodDetailsByRepositoryIdAndScanSessionId(repositoryId, scanSessionId,
                limit);
    }

    public long countTestMethodDetailsByRepositoryIdAndScanSessionId(Long repositoryId, Long scanSessionId) {
        return testArtifactQueryService.countTestMethodDetailsByRepositoryIdAndScanSessionId(repositoryId,
                scanSessionId);
    }

    // list by class id
    public List<TestMethodDetailRecord> listTestMethodDetailsByClassId(Long classId, Integer limit) {
        return testArtifactQueryService.listTestMethodDetailsByClassId(classId, limit);
    }

    public long countTestMethodDetailsByClassId(Long classId) {
        return testArtifactQueryService.countTestMethodDetailsByClassId(classId);
    }

    // Daily metrics
    public List<DailyMetric> recentDailyMetrics(int limit) {
        return dailyMetricQueryService.recent(limit);
    }

    public List<DailyMetric> dailyMetricsRange(LocalDate start, LocalDate end) {
        return dailyMetricQueryService.range(start, end);
    }
    ...
    public List<java.util.Map<String, Object>> getHierarchyByTeam(java.util.Map<Long, Long> latestSessions) {
        return testArtifactQueryService.getHierarchyByTeam(latestSessions);
    }
    ...
    public List<java.util.Map<String, Object>> getHierarchyByPackage(java.util.Map<Long, Long> latestSessions,
            String teamName) {
        return testArtifactQueryService.getHierarchyByPackage(latestSessions, teamName);
    }
    ...
    public List<java.util.Map<String, Object>> getHierarchyByClass(java.util.Map<Long, Long> latestSessions,
            String teamName,
            String packageName) {
        return testArtifactQueryService.getHierarchyByClass(latestSessions, teamName, packageName);
    }
